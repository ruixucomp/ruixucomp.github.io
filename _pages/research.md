...
<table style="border-collapse: collapse; width: 100%; border-style: hidden;">
  <tr>
    <td style="border-style: hidden; width: 40%; vertical-align: middle;">
      <font size="4" color="blue"><strong>Aerospace sustainability</strong></font><br>
      <br>
      <font size="3"><strong>Specific directions:</strong>
      <ul>
        <li>Sustainable aviation fuels (SAF) emission and combustion</li>
        <li>SAF chemical design and synthetis</li>
        <li>Other sustainable energy carriers (e.g., hydrogen)</li>
    ...
    <td style="border-style: hidden; vertical-align: middle;">
      <figure><img src="/images/Aero_sustainability.png" alt="Aerospace sustainability" style="width:60%"></figure>
    </td>
  </tr>
  <tr>
    <td style="border-style: hidden; width: 40%; vertical-align: middle;">
    ...
    <td style="border-style: hidden; vertical-align: middle;">
      <figure><img src="/images/High_speed.png" alt="High speed reacting flow" style="width:60%"></figure>
    </td>
  </tr>
  <tr>
    <td style="border-style: hidden; width: 40%; vertical-align: middle;">
    ...
    <td style="border-style: hidden; vertical-align: middle;">
      <figure><img src="/images/Energy_materials.png" alt="Sustainable energy materials" style="width:60%"></figure>
    </td>
  </tr>
</table>
--->
...
<!---
## Research directions
Click on each link below for each research directions.
<ul>
  <li><a href="/research/research_hychem/" target="_blank" rel="noopener noreferrer">Liquid fuel combustion chemistry</a> </li>
  <li><a href="/research/research_reactingflow/" target="_blank" rel="noopener noreferrer">Reacting flows</a> </li>
  <li><a href="/research/research_abinitio/" target="_blank" rel="noopener noreferrer">Quantum chemistry molecular modeling</a> </li>
  <li><a href="/research/research_saf/" target="_blank" rel="noopener noreferrer">Sustainable aviation fuels</a> </li>
</ul>
--->
